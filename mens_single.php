...
<body>
			...
			<div class="single-page">
				<div class="single-page-row" id="detail-21">
						...
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/s1.jpg">
									<div class="thumb-image detail_images"> <img src="images/s1.jpg" data-imagezoom="true" class="img-responsive" alt="Toffy Dangz"></div>
								</li>
								<li data-thumb="images/s2.jpg">
									 <div class="thumb-image"> <img src="images/s2.jpg" data-imagezoom="true" class="img-responsive" alt="Toffy Dangz"></div>
								</li>
								<li data-thumb="images/s3.jpg">
									<div class="thumb-image"> <img src="images/s3.jpg" data-imagezoom="true" class="img-responsive" alt="Toffy Dangz"></div>
								</li> 
							</ul>
						</div>
					</div>
					<div class="col-md-6 single-top-right">
						...
						<p>This item will be delivered within  working days.</p>
						<div class="rating">
				...
				<div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
					...
					<div class="panel panel-default">
						...
						<div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
							<div class="accordion-image">
								<div class="ac-img">
									<a href="#"><img src="images/product-1.jpg" alt="Toffy Dangz"></a>
								</div>
								<div class="ac-img">
									<a href="#"><img src="images/product-2.jpg" alt="Toffy Dangz"></a>
								</div>
								<div class="clearfix"></div>
							</div>
						</div>
					...
					<div class="panel panel-default">
						...
						<div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
							...
							<p></p>
							<span>5 Stars</span>
							<a href="#" class="next">Next Review ;</a>
						</div>
					</div>
					...
					<div class="panel panel-default">
						...
						<div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
							<h3>Shipping</h3>
							<ul class="ship">
								<li class="day"><i class="fa fa-calendar" aria-hidden="true"></i>  Business Days</li>
	...
	<div class="w3lscopyrightaits">
		<div class="col-md-8 w3lscopyrightaitsgrid w3lscopyrightaitsgrid1">
			<p>© 2017 Toffy Dangz' Collection. All Rights Reserved | Design by <a href="http://w3layouts.com/" target="=_blank"> W3layouts </a> | Developed by </p>
		</div>
