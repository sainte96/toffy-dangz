...
<body>
	...
	<div class="agileheader" id="agileitshome">
		...
		<nav class="navbar navbar-default w3ls navbar-fixed-top">
			<div class="container">
				...
				<div id="bs-megadropdown-tabs" class="navbar-collapse collapse">
                    ...
                    <li class="dropdown">
							<a href="#" class="dropdown-toggle hyper" data-toggle="dropdown"><span> NEW ARRIVALS </span></a>
							...
							<ul class="dropdown-menu aits-w3 multi multi1">
								<div class="row">
									...
									<div class="col-sm-3 w3layouts-nav-agile w3layouts-mens-nav-agileits w3layouts-mens-nav-agileits-3">
										<p>SHOES</p>
										<a href="mens_shoes.html"><img src="images/men-nav-2.jpg" alt="Groovy Apparel"></a>
									</div>
							...
							<ul class="dropdown-menu multi multi2">
								<div class="row">
									...
									<div class="col-sm-3 w3layouts-nav-agile w3layouts-womens-nav-agileits w3layouts-womens-nav-agileits-3">
										<p>SKIRTS & SHORTS</p>
										<a href="womens_skirts.html"><img src="images/women-nav-2.jpg" alt="Groovy Apparel"></a>
									</div>
                                    <div class="col-sm-3 w3layouts-nav-agile w3layouts-womens-nav-agileits w3layouts-womens-nav-agileits-3">
										<p>GOWNS</p>
		...
		<div class="w3slideraits">
			<div class="fluid_dg_wrap fluid_dg_emboss pattern_1 fluid_dg_white_skin" id="fluid_dg_wrap_4">
				<div data-thumb="images/slide-1-small.jpg" data-src="images/Dangz Collections/TOFFFY DANGS LOGO.jpg"></div>
				<div data-thumb="images/slide-1-small.jpg" data-src="images/Dangz Collections/TOFFFY DANGS LOGO.jpg"></div>
				<div data-thumb="images/slide-1-small.jpg" data-src="images/Dangz Collections/TOFFFY DANGS LOGO.jpg"></div>
				<div data-thumb="images/slide-1-small.jpg" data-src="images/Dangz Collections/TOFFFY DANGS LOGO.jpg"></div>
				<div data-thumb="images/slide-1-small.jpg" data-src="images/Dangz Collections/TOFFFY DANGS LOGO.jpg"></div>
	...
	<div class="agilemodel-slider">
		<div id='film_roll_1'>
			<div><img src="images/Dangz Collections/TOFFFY DANGS LOGO.jpg" alt="Toffy Dangz"></div>
			<div><img src="images/Wallpaper.jpg" alt="Toffy Dangz"></div>
			<div><img src="#" alt="Toffy Dangz"></div>
			<div><img src="#" alt="Toffy Dangz"></div>
			<div><img src="#" alt="Toffy Dangz"></div>
			<div><img src="#" alt="Toffy Dangz"></div>
			<div><img src="#" alt="Toffy Dangz"></div>
		...
		<div class="container">
			...
			<div class="wthreehome-latest-grids">
				<div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid1">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="images/home-latest-1.jpg" alt="Toffy Dangz">
				...
				<div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid2">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="images/home-latest-2.jpg" alt="Toffy Dangz">
							<figcaption></figcaption>
						</figure>
					</div>
				...
				<div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid3">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="images/home-latest-3.jpg" alt="Toffy Dangz">
							<figcaption></figcaption>
						</figure>
					</div>
					<h4>WATCHES</h4>
				...
				<div class="col-md-6 wthreehome-latest-grid wthreehome-latest-grid4">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="images/home-latest-4.jpg" alt="Toffy Dangz">
							<figcaption></figcaption>
						</figure>
					</div>
					<h4>BEACH WEAR</h4>
	...
	<div class="aitsclearance-sales">
		<div class="aitsclearance-sales-text">
			<h2>MEN CHECK THIS OUT</h2>
			<h4></h4>
			<h5> <small><sup>*</sup></small></h5>
			<div class="wthreeshop-a">
		...
		<div class="container">
			...
			<div class="agileshoppinggrids">
				<div class="col-md-6 agileshoppinggrid agileshoppinggrid1">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="images/mens.jpg" alt="Toffy Dangz">
							<figcaption></figcaption>
						</figure>
					</div>
				</div>
				<div class="col-md-6 agileshoppinggrid agileshoppinggrid2">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="images/womens.jpg" alt="Toffy Dangz">
							<figcaption></figcaption>
						</figure>
					</div>
				</div>
	...
	<div class="agileinfonewsl">
		...
		<p>Subscribe to us to get highest-level access to our new collections and trends</p>
		<div class="wthreeshop-a">
	...
	<div class="w3lscopyrightaits">
		<div class="col-md-8 w3lscopyrightaitsgrid w3lscopyrightaitsgrid1">
			<p>© 2017 Toffy Dangz' collections. All Rights Reserved | Design by <a href="http://w3layouts.com/" target="=_blank"> W3layouts Developed by </a></p>
		</div>
